...
function App() {
  ...
  return (
    <div className={themeMode ? 'app' : 'app dark-mode'}>
      <div className="level">
        <div>
        ...
        <button onClick={()=>{setThemeMode(!themeMode)}} className="app__dark-mode-btn icon level-right">
          <FontAwesomeIcon color={themeMode ? "" : "#FFA500"} icon={themeMode ? faMoon : faSun} />
        </button>
